...
public class MVCBoardDAO extends DBConnPool {
    ...
    public MVCBoardDTO selectView(String idx) {
    	...
    	try {
    		...
    		System.out.println("게시물 상세정보 출력중 오류");
    		e.printStackTrace();
    	}
	...
	public int updatePost(MVCBoardDTO dto) {
		...
		try {
			...
			e.printStackTrace();
			System.out.println("업데이트시 예외 발생");
		}
	...
	public void downCountPlus (String idx) {
		...
		psmt.executeUpdate();
			...
			e.printStackTrace();
			System.out.println("다운로드 횟수 증가시 예외발생");
		}
	...
	public boolean confirmPassword(String pass , String idx) {
		...
		try {
				// count(*) : 레코드가 존재하면 client에서 넘긴 pass,idx 값이 DB에 존재
			String query = "select count(*) from mvcboard where pass = ? ands idx = ?";
			psmt = con.prepareStatement(query);
